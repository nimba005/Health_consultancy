            ...
            <RegisterUi>
                ...
                <form className=" flex flex-col gap-8">
                    <div className=" flex flex-col gap-5">
                        ...
                        <TextInput name="user_name" control={control} label="Username" error={errors.user_name} type="text" />
                        ...
                        <TextInput name="password" control={control} label="Password" type="password" error={errors.password} />
                        <TextInput name="confirm_password" control={control} label="Confirm Password" type="password" error={errors.confirm_password} />
